...
function hapusSimbol(str) {           //membuat fungsi hapusSimbol dengan parameter str
var hasilAkhir = '';                       // membuat variabel hasilAkhir dalam fungsi hapusSimbol
    for (i=0; i < str.length; i++){
        if (str[i] === 'a' || str[i] === 'b' || str[i] === 'c' || str[i] === 'd' || str[i] === 'e' || str[i] === 'f'
            ...
            || str[i] === 'y' || str[i] === 'z' || str[i] === '1' || str[i] === '2' || str[i] === '3' || str[i] === '4'
            || str[i] === '5' || str[i] === '6' || str[i] === '7' || str[i] === '8' || str[i] === '9' || str[i] === '0'  
        ){
            hasilAkhir = hasilAkhir + str[i]
        }
    }
return hasilAkhir;
}
